...
namespace AssetBundleBrowser
{
    ...
    internal class AssetBundleEditor : Editor
    {
        ...
        internal bool hashFoldout = false;
        public override void OnInspectorGUI()
        {
            ...
            {
                if (bundle.Contains("AssetBundleManifest"))
                {
                    hashFoldout = EditorGUILayout.Foldout(hashFoldout, "Hash128");
                    if (hashFoldout)
                    {
                        ...
                        foreach (string bundleName in manifest.GetAllAssetBundles())
                        {
                            ...
                            EditorGUILayout.LabelField(bundleName, hash.ToString());
