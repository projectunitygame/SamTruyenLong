...
public class LGameSlot25LineLobby : UILayer
{
    #region Properties
    [Header("--------------------------------------------------")]
    [Space(40)]
    [Header("CONFIG")]
    public SRSSlot25LineConfig _config;
    ...
    public void Init()
    {
        ...
        _server = SignalRController.Instance.CreateServer<Slot25lineSignalRServer>((int)_config.gameId);
