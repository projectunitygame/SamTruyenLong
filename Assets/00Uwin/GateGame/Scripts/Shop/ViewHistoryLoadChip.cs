...
public class ViewHistoryLoadChip : AbsShop
{
    [Header("--------------------------------------------------")]
    [Space(40)]
    ...
    public List<ElementHistoryLoadRong> listElementHistory;

    private List<TopupHistory> listData;
    private int itemInPage = 9;
    ...
    private void ShowHistory(List<TopupHistory> listDataInput)
    {
